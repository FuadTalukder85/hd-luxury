    ...
    <div className="relative">
      <div>
        <div className="bg-white flex md:hidden justify-between items-center py-2 px-3 md:px-0">
          ...
          <div
            id="menu"
            className="bg-seaBlue text-white text-2xl px-2 py-1 rounded-md hover:bg-yellow transition-all duration-500 cursor-pointer"
          >
            <RiMenuFold2Fill />
          </div>
          <div
          ...
          >
            <div className="flex justify-between items-center">
              ...
              <div
                id="closeBtn"
                className="bg-seaBlue text-white text-xl px-2 py-1 rounded-md hover:bg-yellow transition-all duration-500 cursor-pointer"
              >
                <IoCloseSharp />
              </div>
            </div>
        ...
        <div className="flex gap-5 items-center mt-4 md:mt-0">
          ...
          <div className="flex items-center gap-2 relative dropdown-container">
            {currentUser?.image ? (
              ...
              <div className="w-[40px] h-[40px] bg-gray-200 rounded-lg flex items-center justify-center text-seaBlue font-bold">
            ...
            <div>
              ...
              {isDropdownOpen && (
                <div className="absolute top-full mt-3 right-0 bg-white border border-gray-200 rounded-md shadow-lg w-36 z-50">
