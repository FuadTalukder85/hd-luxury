...
import { TArrowProps, TPropertyTypes } from "../../../shared/types/types";
import ReusableBtn from "../../../shared/components/ui/reusableBtn";

const NextArrow = ({ onClick }: TArrowProps) => {
  return (
    <div className="flex justify-end absolute -bottom-24 right-0 px-6 md:px-0 z-10">
      <div
...
const FeaturedListing = () => {
  ...
  const featuredProperty = data?.filter(
    (dt: TPropertyTypes) => dt.propertyFor === "Featured" || dt.status === "approved"
  );
